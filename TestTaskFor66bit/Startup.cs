...
namespace TestTaskFor66bit
{
    public class Startup
    {
        ...
        {
            services.AddSingleton<IMapper>(new Mapper(GetMapperConfiguration()));//сингл чтобы не тянуть маппер каждый запрос 
            services.AddTransient<IPlayerRepository, PlayerRepository>();//создаём обьект в рамках одного запроса
